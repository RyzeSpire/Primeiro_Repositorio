...
int main(int argc, char** argv)
{
   ...
   if (argc != 3)
    {
        printf("Uso: ./rh <nome_arquivo_binario> <opcao_insercao: -inicio/-fim>\n");
        return -1;
    }

    
    if (strcasecmp(argv[2], "-inicio") != 0 && strcasecmp(argv[2], "-fim") != 0)
    {
        printf("Erro: Opcao de insercao invalida. Use '-inicio' ou '-fim'.\n");
        printf("Uso: ./rh <nome_arquivo_binario> <opcao_insercao: -inicio/-fim>\n");
        return -2; 
    }
                    ...
                    do {
                        ...
                        switch (sub_menu) {
                            ...
                            case 2: aux = novo_registro_rh();
                                    ...
                                    if(!aux) printf("Erro, nao foi possivel criar novo registro!");

                                    if(strcasecmp(argv[2],"-inicio") == 0) 
                                    {
                                        insere_registro_inicio_rh(aux, &lista_rh);
                                    }
                                    else if(strcasecmp(argv[2],"-fim") == 0) 
                                    {
                            ...
                            case 5:
                                    ...
                                    if (aux) {
                                        mostrar_dados_registro_rh(aux);
                                        printf("\nConfirma a exclusao do registro do funcionario (S/N)? ");
                                        scanf(" %c", &resposta);
                                        getchar();
                                        if (resposta == 'S' || resposta == 's') 
                                        {
